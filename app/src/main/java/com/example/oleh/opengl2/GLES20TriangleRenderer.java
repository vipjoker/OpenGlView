...
class GLES20TriangleRenderer implements GLSurfaceView.Renderer, View.OnTouchListener {
 ...
 interpolator = new AccelerateInterpolator();
        ...
        mTriangleVertices = rectangle.floatBuffer();
        Circle circle = new Circle(1,12);
...
//        float[] temp = new float[16];
        ...
        float inter = interpolator.getInterpolation(counter ) * (float) Math.sin( counter +=0.01) * 360;
        Log.v("interpolator" , String.format("iter %f",inter));
